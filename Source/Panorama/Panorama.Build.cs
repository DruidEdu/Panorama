...
public class Panorama : ModuleRules
{
    ...
    {
        return Path.GetFullPath(Path.Combine(GetModulePath(), "../../ThirdParty/"));
    }

    public Panorama(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        //// * LIBBMP *
        //// **********
        //PublicIncludePaths.Add(Path.Combine(GetThirdPartyPath(), "libBMP/CPP"));
        //Console.WriteLine("LibBMP Include Path is: " + Path.Combine(GetThirdPartyPath(), "libBMP/CPP"));
